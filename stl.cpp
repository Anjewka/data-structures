...
int main()
{
    ...
    m.insert(5, 5);
    std::cout << "Map:" << '\n';
    stl::map<int, int>::iterator i = m.begin();
    for(; i != m.end() ; ++i) {std:: cout << i.first << " " << i.second << '\n';}
    ...
    s.insert(0);
    s.insert(1);
    stl::set<int>::iterator i1 = s.begin();
    for(; i1 != s.end() ; ++i1) {std:: cout << *i1 << '\n';}
    std::cout << *s.end();
    std::cout << '\n' << "list:" << '\n';
    stl::list<int> l;
    l.push_back(0);
    ...
    l.push_back(1);
    l.push_back(3);
    stl::list<int>::iterator i2 = l.begin();
    for(; i2 != l.end() ; ++i2) {std:: cout << *i2 << '\n';}
    std::cout << *l.end();
    return 0;
}